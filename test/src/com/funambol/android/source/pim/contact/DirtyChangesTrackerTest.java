...
public class DirtyChangesTrackerTest extends AndroidBaseTest {
    ...
    private DirtyChangesTracker tracker;
    ...
    public void setUp() throws Exception {
        ...
        Log.initLog(new AndroidLogAppender("DirtyChangesTrackerTest"), Log.TRACE);
    ...
    private void initSyncSourceTracker() {
        ...
        try {
            ...
            tracker = new DirtyChangesTracker(getContext(),
    ...
    public void testMultipleChanges() throws Exception {
        ...
        newItem1.setSyncStatus(SyncSource.SUCCESS_STATUS);
        newItem2.setSyncStatus(SyncSource.SUCCESS_STATUS);
        ...
        itemsStatus = new Vector();
        itemsStatus.addElement(new ItemStatus(updated.getKey(), SyncSource.SUCCESS_STATUS));
        ...
        itemsStatus = new Vector();
        itemsStatus.addElement(new ItemStatus(deleted.getKey(), SyncSource.SUCCESS_STATUS));
        source.applyItemsStatus(itemsStatus);
    ...
    public void testReset() {
        ...
        whereClause.append(RawContacts.DELETED).append("=1").append(")");

        Cursor items = resolver.query(RawContacts.CONTENT_URI, null,
                whereClause.toString(), null, null);

        assertEquals(items.getCount(), 0);
