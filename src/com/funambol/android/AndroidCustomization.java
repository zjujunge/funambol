...
public class AndroidCustomization implements Customization {
    ...
    private final boolean  PICTURES_AVAILABLE      = true;
    private final boolean  PICTURES_ENABLED        = true;

    private final String   VIDEOS_DEFAULT_URI      = "video";
    private final boolean  VIDEOS_AVAILABLE        = true;
    private final boolean  VIDEOS_ENABLED          = true;

    private final String   FILES_DEFAULT_URI      = "file";
    private final boolean  FILES_AVAILABLE        = true;
    private final boolean  FILES_ENABLED          = true;
