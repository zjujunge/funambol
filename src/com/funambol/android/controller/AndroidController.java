...
public class AndroidController extends Controller {
    ...
    private static final String TAG_LOG = "AndroidController";
    ...
    // Constructor
    private AndroidController(Application app, ControllerDataFactory fact,
                              ...
                              AppSyncSourceManager appSyncSourceManager)
    {
        ...
        syncModeHandler = new AndroidSyncModeHandler(mContext, configuration);
    }

    public static AndroidController getInstance(Application app,
    ...
    {
        if (instance == null) {
            instance = new AndroidController(app, fact, configuration, customization,
    ...
    public AndroidSyncModeHandler getSyncModeHandler() {
        return (AndroidSyncModeHandler)syncModeHandler;
    }
