...
public class ContactAppSyncSourceConfig extends AppSyncSourceConfig {
    ...
    public ContactAppSyncSourceConfig(AppSyncSource appSource, Customization customization,
    ...
    public void save() {
        ...
        configuration.saveBooleanKey(CONF_KEY_USE_DIRTY_CHANGES_TRACKER, useDirtyChangesTracker);
    ...
    public void load(SourceConfig sourceConfig) {
        ...
        useDirtyChangesTracker = configuration.loadBooleanKey(CONF_KEY_USE_DIRTY_CHANGES_TRACKER, false);
    ...
    public void setUseDirtyChangesTracker(boolean value) {
        useDirtyChangesTracker = value;
        dirty = true;
    }

    public boolean getUseDirtyChangesTracker() {
        return useDirtyChangesTracker;
    }
}
